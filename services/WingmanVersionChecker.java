...
public class WingmanVersionChecker {
     ...
     *
     */
    public Boolean isBinaryToolsUpdateRequired() {

        String installedToolVersion = "";
        try {
            WingmanConstants.BinaryToDownloadByPlatform toolsToDownload = getPlatformBinaryName();
    ...
    public void downloadBinaryUpdate(Project project, CefQueryCallback callback, Map<String, Object> requestBody) {
        try {
            if (!BinaryDownloadServiceImpl.isWingmanEnvironmentSupported(callback)) {
                return;
            }
