...
public class WingmanRoutesService {
    ...
    public static Boolean handleInitializeWingman(Project project, Map<String, Object> requestBody,
        ...
        try {
            ...
            if (!isWingmanEnvironmentSupported(callback, project)) {
                return false;
            }
            ...
            try {
                ...
                if (!downloadHistoryAvailable) {
                        ...
                        if (downloadSuccess) {
                            ...
                            if (wingmanUserInfo.getIsPremiumPlan()) {
                               ...
                               // new BinaryDownloadServiceImpl().startBitoWingmanAfterDownload(project, startSuccess -> {
                                 WingmanNewProcessService.startWingmanServiceAsync(project,startSuccess -> {
                                    if (startSuccess) {
                                        logger.info(
                    ...
                    if (!isWingmanBinaryExists(project)) {
                        boolean isFreshDownload = true;
                        logger.info(
                    ...
                    toolsUpdateResult -> {
                        ...
                        if (isPremiumPlan) {
                            ...
                            if (!isRunning) {
                               ...
                               boolean isStarted = WingmanNewProcessService.startWingmanService(project);

                                callback.accept(isStarted);
                            } else {
